...
# 2. change header
def get_dzzx_header():
    header = "grade,clrm,星期一-1,星期一-2,星期一-3,星期一-4,星期一-5,星期一-6,星期一-7,星期一-8,星期一-9,星期一-10,星期一-11,星期二-1,星期二-2,星期二-3,星期二-4,星期二-5,星期二-6,星期二-7,星期二-8,星期二-9,星期二-10,星期二-11,星期三-1,星期三-2,星期三-3,星期三-4,星期三-5,星期三-6,星期三-7,星期三-8,星期三-9,星期三-10,星期三-11,星期四-1,星期四-2,星期四-3,星期四-4,星期四-5,星期四-6,星期四-7,星期四-8,星期四-9,星期四-10,星期四-11,星期五-1,星期五-2,星期五-3,星期五-4,星期五-5,星期五-6,星期五-7,星期五-8,星期五-9,星期五-10,星期五-11\n"
    return header
...
def generate_clean_schedule():
    ...
    for header in headers:
        if header == "clrm":
            ...
            clrm_col = clrm_col[0:len(clrm_col):2]
            clean_df[header] = [int(i) for i in clrm_col]
        elif header == "grade":
            grade_col = list(df["grade"])
            clean_df[header] = grade_col[0:len(grade_col):2]
        else:
            ...
            for line in input:
                ...
                for weekday in day_of_week:
                    ...
                    for st in contents[start_i:end_i+1]:
                        ...
                        index = index + 1
                        curr_line = "%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n" % (index, weekday, class_time[0], class_time[1], schl, class_n, teacher, subject, class2clrm[int(class_n)], class2aio[int(class_n)], grade)
